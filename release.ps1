...
cp target\i686-pc-windows-msvc\release\injector.exe release\injector32.exe
cp target\x86_64-pc-windows-msvc\release\injector.exe release\injector64.exe
